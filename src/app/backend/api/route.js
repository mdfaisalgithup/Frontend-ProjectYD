...
return NextResponse.json({ title: info.videoDetails.title, formats: hdMp4Formats, audioFormat: audioFormat, videoUrl: url, vthumbnail: thumbnail, ausioSizesFor: ausioSizesFor});
